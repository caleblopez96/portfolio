...
const technologies = [
  ...
  { name: "C#", color: "bg-white dark:bg-gray-800 hover:bg-gray-900 hover:text-white dark:hover:bg-gray-200 dark:hover:text-gray-900", image: csharpIcon },

  { name: "SQL", color: "bg-white dark:bg-gray-800 hover:bg-gray-900 hover:text-white dark:hover:bg-gray-200 dark:hover:text-gray-900", image: sqlIcon },
