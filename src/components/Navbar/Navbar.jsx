    ...
    return (
        <nav className="navbar font-main bg-light-background dark:bg-dark-background fixed w-full z-50">
            ...
            <div className="flex items-center">
                <button onClick={toggleDarkMode} className="mr-4 p-2 rounded-full bg-light-text dark:bg-dark-text">
                    {isDarkMode ? "☀️" : "🌙"}
                </button>
            ...
            <ul className={`font-mono nav-menu ${isActive ? "active" : ""} bg-light-background dark:bg-dark-background`}>
                <li className="nav-item">
                    <a href="#Top" className="nav-link current-link text-light-primary" onClick={handleLinkClick}>
                        home
                    </a>
                </li>
                <li className="nav-item">
                    <a href="#About" className="nav-link text-light-text dark:text-dark-text" onClick={handleLinkClick}>
                        about
                    </a>
                </li>
                <li className="nav-item">
